...
public class customerDAOImp implements customerDAO {
	...
	private final String SQL_INSERT_CUSTOMER = "insert into slam_customers(cust_name,  cust_mobile , cust_regdate ,cust_location , cust_email ,cust_address, cust_saddress, cust_pincode ,cust_status ,cust_lastlogindate, cust_password ) values(?,?,?,?,?,?,?,?,?,?,?)";
	...
	public void updateshipmentaddress(int custid, String shp) {
		String updateQuery = "UPDATE slam_customers SET cust_saddress = ? WHERE cust_id = ?";
		jdbcTemplate.update(updateQuery, shp, custid);
	}
